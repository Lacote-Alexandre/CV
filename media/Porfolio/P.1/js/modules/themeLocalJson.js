...
const theme = {
    ...
    changeTheme: function(event) {
        ...
        localStorage.setItem("darkMode", infoJsonToSave);
    ...
    init: function() {
        ...
        const themeJsonInfoOfLS = localStorage.getItem("darkMode");
        const themeValueOfLS = JSON.parse(themeJsonInfoOfLS);
        ...
        if(themeValueOfLS == "dark") {
            ...
            theme.themeValue = themeValueOfLS;
        }
 ...
 * ---------------------
 * 
 *  LIGNE 52 : On sauvegarde l'état de notre thème
        const infoJsonToSave = JSON.stringify(theme.themeValue);
        localStorage.setItem("darkMode", infoJsonToSave);

    LIGNE 66 : lors de l'initialisation, je lis la valeur contenu dans la clé thème
        const themeJsonInfoOfLS = localStorage.getItem("darkMode");
        const themeValueOfLS = JSON.parse(themeJsonInfoOfLS);
 * 
 * 
